    ...
    <section style={{ backgroundColor: "#1a1a1a", paddingTop: "5rem", paddingBottom: "5rem" }}>
      ...
      <div className="container-custom">
          ...
          {courses.map((course) => (
            <Link key={course.id} href={["/academy/courses/", course.slug].join("")} className="course-card">
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem" }}>
                ...
                <span style={{ fontSize: "0.72rem", color: "rgba(255,255,255,0.4)" }}>{course.duration}</span>
              </div>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: "1.25rem" }}>
                <span style={{ fontWeight: 600, color: "white", fontSize: "0.95rem" }}>{formatPrice(course.price)}</span>
                <span style={{ fontSize: "0.72rem", color: "rgba(255,255,255,0.4)", letterSpacing: "0.1em" }}>Learn more →</span>
              </div>
            </Link>
          ))}
        </div>
        ...
        <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
          <Link href="/academy/apply" className="btn-white">Apply Now</Link>
          <Link href="/academy/courses" style={{ fontSize: "0.72rem", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 500, color: "rgba(255,255,255,0.6)", display: "flex", alignItems: "center", gap: "0.5rem", borderBottom: "1px solid rgba(255,255,255,0.3)", paddingBottom: "2px" }}>
            View All Courses →
          </Link>
        </div>
      </div>
